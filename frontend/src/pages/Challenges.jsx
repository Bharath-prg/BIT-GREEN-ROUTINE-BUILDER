...
const Challenges = () => {
  ...
  const activeChallengeCombos = activeChallenges.map(p => 
    `${p.challengeId?._id}-${p.habitId?._id}`
  )
  ...
  return (
    <div className="space-y-6">
      {/* Page Header */}
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Streak Challenges</h1>
      ...
      {activeTab === 'active' && (
        <div className="space-y-4">
          {activeChallenges.map((progress) => {
            ...
            const percentage = (progress.completedDays / challenge.durationDays) * 100
            ...
            return (
              <div key={progress._id} className="card">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                  {challenge.durationDays - progress.completedDays} days remaining
                </p>
              </div>
            )
          })}
      ...
      {activeTab === 'completed' && (
        <div className="space-y-4">
          {completedChallenges.map((progress) => {
            ...
            return (
              <div key={progress._id} className="card bg-gradient-to-r from-eco-green-50 to-green-50 dark:from-gray-800 dark:to-gray-700">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg max-w-md w-full p-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Which habit do you want to take the {selectedChallenge.durationDays}-day challenge for?
            </p>
